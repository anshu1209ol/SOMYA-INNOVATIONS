...
export const metadata: Metadata = createMetadata({
  title: "Digital Solutions & Software Development | SOMYA INNOVATIONS",
  description:
    "SOMYA INNOVATIONS develops websites, web applications, dashboards, custom software, APIs, databases and cloud solutions.",
...
export default function DigitalSolutionsPage() {
  const breadcrumbSchema = getBreadcrumbSchema([
    { name: "Home", url: "/" },
    { name: "Solutions", url: "/solutions/digital-solutions" },
    { name: "Digital Solutions", url: "/solutions/digital-solutions" },
  ]);
        ...
        <div className="relative pt-6 pb-16 lg:pb-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <DisplayHeading as="h2" className="text-left text-[#11110F]">
