...
export const metadata: Metadata = createMetadata({
  title: "AI Solutions | Computer Vision, Machine Learning & Automation",
  description:
    "Practical AI-powered solutions for organizations. Explore applied capabilities across Computer Vision, Machine Learning, Automation, Document Intelligence, and Custom AI Applications.",
  path: "/ai-solutions",
});
...
const AI_DETAILED_SERVICES: AiServiceDetail[] = [
  ...
  },
  {
    ...
    applications: [
      "Bespoke proprietary scoring engines and commercial calculation portals",
      "Air-gapped on-premise AI assistants for sensitive confidential data",
      "Integrated field engineering diagnostic applications with offline inference",
      "Enterprise workflow portals uniting specialized microservices",
    ],
    ctaText: "Discuss Custom AI Applications",
  },
];
...
const WORKFLOW_STEPS = [
  {
    ...
    summary: "Identify friction & define metrics",
    description:
      "We begin by identifying repetitive bottlenecks, manual error sources, or high-friction workflows with measurable commercial value.",
    icon: Compass,
        ...
        <div className="relative pt-6 pb-16 lg:pb-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <DisplayHeading className="text-left text-[#F1EBDD]">
                AI that works for{" "}
              ...
              return (
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    {/* Middle Column: Business Problem Addressed */}
                    <div className="lg:col-span-4 p-6 rounded-xl bg-[#11110F] border border-white/[0.08] space-y-3">
                    ...
                    {/* Right Column: Example Applications */}
                    <div className="lg:col-span-4 p-6 rounded-xl bg-[#11110F] border border-white/[0.08] space-y-3">
                      <div className="flex items-center gap-2 text-xs font-mono uppercase tracking-wider text-[#68704A]">
                        ...
                        <span>Example Applications</span>
                      </div>
                      <ul className="space-y-2.5">
                        {service.applications.map((app) => (
                          <li key={app} className="flex items-start gap-2.5 text-xs text-[#F1EBDD]/80 leading-relaxed">
