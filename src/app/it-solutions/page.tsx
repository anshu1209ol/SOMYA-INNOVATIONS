...
export const metadata: Metadata = createMetadata({
  title: "IT Solutions | Enterprise Hardware, Networking & Infrastructure",
  description:
    "Complete IT solutions for modern businesses. Explore hardware provisioning, enterprise networking, facility security, business software, and proactive IT support.",
  path: "/it-solutions",
});
        ...
        <div className="relative pt-6 pb-16 lg:pb-24 text-center">
          <div className="inline-flex items-center gap-2 mb-6">
            <Badge variant="olive" dot>
              Enterprise IT Infrastructure & Systems
            </Badge>
          </div>
