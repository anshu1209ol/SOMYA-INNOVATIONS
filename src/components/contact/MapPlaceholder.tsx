...
export function MapPlaceholder({
  ...
  return (
    <div
      className={`relative w-full h-[440px] rounded-3xl overflow-hidden border border-white/[0.1] bg-gradient-to-br from-[#11110F] via-zinc-950 to-[#641F2A]/20 shadow-2xl flex flex-col justify-between p-6 sm:p-8 ${className}`}
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center pointer-events-none">
        <div className="relative">
          <div className="w-12 h-12 rounded-full bg-[#641F2A]/30 animate-ping absolute inset-0" />
          <div className="w-12 h-12 rounded-full bg-[#641F2A]/60 border border-[#852E3B]/60 flex items-center justify-center text-[#F1EBDD] shadow-[0_0_30px_rgba(100,31,42,0.6)] backdrop-blur-sm relative z-10">
            <MapPin className="w-6 h-6 text-[#F1EBDD]" />
          </div>
        </div>
        <div className="mt-2 px-3 py-1 rounded-full bg-zinc-950/90 border border-[#641F2A]/50 text-xs font-mono text-[#F1EBDD] shadow-lg whitespace-nowrap">
          {city}
        </div>
      </div>
      ...
      {isLayerModalOpen && (
        <div className="absolute top-16 right-6 z-30 w-80 p-4 rounded-2xl bg-zinc-950/95 border border-[#641F2A]/40 shadow-2xl backdrop-blur-md text-xs space-y-2 animate-in fade-in">
          ...
          <div className="pt-2 text-[10px] text-[#E8DFCF] font-mono">
      ...
      <div className="relative z-20 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div className="max-w-md p-4 rounded-2xl bg-zinc-950/85 border border-white/[0.08] backdrop-blur-md space-y-1.5 shadow-xl">
          <div className="flex items-center gap-2 text-xs font-semibold text-[#E8DFCF]">
            <Compass className="w-3.5 h-3.5 text-[#68704A]" />
        ...
        <div className="flex items-center gap-2 shrink-0">
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#641F2A] hover:bg-[#852E3B] text-[#F1EBDD] text-xs font-semibold shadow-[0_0_20px_rgba(100,31,42,0.35)] transition-all"
          >
